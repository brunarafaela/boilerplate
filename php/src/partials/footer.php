    ...
    <div class="row">
      <div class="col-6 col-md-2 mb-3">
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item mb-2">
            <a href="#" class="nav-link p-0 text-body-secondary" data-ptbr="Sobre" data-en="About">Sobre</a>
          </li>
        </ul>
      </div>
      <div class="col-6 col-md-2 mb-3">
...
<script type="text/javascript" language="JavaScript" src="/assets/js/global.min.js"></script>
<script type="text/javascript" language="JavaScript" src="/assets/js/multi-language.min.js"></script>
</body>
</html>